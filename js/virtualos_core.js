var resume={
	...
	Execute: function(obj){
		...
		if (len>0){
			...
			!resume.FExtension[ExecTarget.type] 
				? alert("No app for this file type...") 
				: resume.Apps.list[resume.FExtension[ExecTarget.type]].start(ExecTarget, obj.newWindow, obj.ItemPath, FullStringPath)
		}
	},
